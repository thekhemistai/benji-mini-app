...
**The Central Node** — All trading-related memory connects here.
...
## Active Strategy
- [[memory/trading/polymarket-arbitrage.md|Polymarket Arbitrage Strategy]] — *The complete playbook*

## Live Operations
- [[memory/trading/polymarket-watchlist.md|Market Watchlist]] — *What I'm watching right now*
- [[memory/trading/arb-results.md|Trade Results]] — *Paper trading log & analysis*

## Tools & Workflows
- [[TOOLS.md|TOOLS.md]] — *Bankr CLI, price checking, execution*
...
```
Information Arbitrageur (Identity)
         ↓
...
*This file is the entry point. Start here to understand the trading operation.*